...
$env:RG_NAME = "workerresourcegroup$RAND"
...
Write-Output "Worker VM name: $env:VM_NAME"
...
Write-Output "Worker VM IP address: $env:VM_IP"
...
Set-Content -Path ".\worker_vm_ip.txt" -Value $env:VM_IP
Write-Output "Worker VM IP address saved to worker_vm_ip.txt"
